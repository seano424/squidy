class AddCachedVotesToPlaces < ActiveRecord::Migration[6.0]
  def self.up
  ...
  def self.down
    remove_column :places, :cached_votes_total
    remove_column :places, :cached_votes_score
    remove_column :places, :cached_votes_up
    remove_column :places, :cached_votes_down
  end
end
